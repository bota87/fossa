...
tapScreenT = Toccami quando hai finito
scanMeT = Leggi il QR code e tocca lo schermo quando hai finito
totalT = Totale: 
fossaT = Dai VALORE ai tuoi spicci:
satsT = convertili
forT = in
fiatT = Bitcoin!
feedT = 
...
tooMuchFiatT = Troppa FIAT!
contactOwnerT = Mi serve una pausa
failedT = FALLITO
